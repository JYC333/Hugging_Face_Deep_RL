import gym
from utils_gym import push_to_hub, load_from_hub, evaluate_agent
from QLearning_gym import QLearning
...
def Taxi():
    ...
    model = QLearning(env, n_training_episodes=1000, eval_seed=eval_seed)
